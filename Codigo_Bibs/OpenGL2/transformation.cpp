...
void drawRay(Point start, Point end, int ticks) {
  ...
  Point r = Point::lerp(start, end, 0.9);  // 90% of way from start to end
  Vector n(start, end);
  Vector nperp = n.perp();
  Point r1 = Point::lerp(r, nperp, 0.02);
  Point r2 = Point::lerp(r, nperp, -0.02);
