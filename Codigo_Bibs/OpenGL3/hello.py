...
def init():
	...
	#glVertexAttribPointer(1, 3, GL_FLOAT, False, sizeof(ctypes.c_float)*6   , c_void_p(3*sizeof(ctypes.c_float)))#stride e offset para dois atributos no mesmo vbo
	glBindAttribLocation(shaderProgram, 0, 'vertexPosition')  # name of attribute in shader#talvez nao precise se for glsl v 330
